# AdaptLearn v2 — SM-2 Spaced Repetition Learning Engine
...
Self-contained education platform combining SM-2 spaced repetition with Ebbinghaus forgetting curve estimation, Bloom's taxonomy cognitive progression, prerequisite knowledge graphs, Vygotsky zone-of-proximal-development difficulty adaptation, and achievement-based gamification. Features deterministic PRNG for reproducible learning sessions, comprehensive JSDoc documentation on every method, and rich analytics dashboards with personalized study recommendations.
